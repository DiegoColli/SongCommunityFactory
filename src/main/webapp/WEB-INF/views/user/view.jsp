...
<html lang="en">
    ...
    <head>
        ...
        <title>Song Community Factory | Visualizar </title>
        ...
        <div class="page-wrapper">
            ...
            <div class="breadcrumb-container">
                <div class="container">
                    <ol class="breadcrumb">
                        ...
                        <li><i class="fa fa-home pr-10"></i><a href="#">Perfil do Usuário</a></li>
                    </ol>
                </div>
            </div>
            ...
            <section class="main-container light-gray-bg pv-30 clearfix">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                            <h2 class="page-title">Visualizar Usuário ${model.username}</h2>
